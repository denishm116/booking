            ...
            <div class="col-md-8  shadow-lg mb-5 pt-5">
                ...
                <form {{ $novalidate /* 36 */ }} method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="patronymic" type="hidden"
                    ...
                    <div class="row mt-4 text-center align-content-center align-self-center">
                        <div class="col col-md-auto ">
                            <div class="checkbox px-5">
                                ...
                                Зарегистрировать меня, как <b>арендодателя</b>. Я принимаю условия <a
                                    href="landlord_agreement">договора на оказание возмездных услуг</a>.
                    ...
                    <div class="row mb-5 text-center">
                        <div class="col col-md-auto">
                            <div class="checkbox px-5"><small>
                                    Регистрируясь на сайте, Вы даете согласие на обработку своих персональных данных и
                                    соглашаетесь с <a href="guest_agreement">правилами и условиями для поездок</a>, <a
                                        href="https://krim-leto.ru/confidential_policy">и политикой конфиденциальности
                                    </a>.
                                </small>
                            </div>
                        </div>
