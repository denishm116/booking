...
return [
    ...
    */
    ...
    'custom' => [
        'room_number' => [
            'required' => 'Поле Количество комнат обязательно для заполнения.',
        ],
        'room_size' => [
            'required' => 'Поле Количество мест обязательно для заполнения.',
        ],
        'price' => [
            'required' => 'Поле Базовая стоимость обязательно для заполнения.',
        ],
    ],
